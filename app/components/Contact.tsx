...
const socials = [
  {
    icon: LinkedInIcon,
    href: "https://linkedin.com/in/akshat-patel64",
    label: "LinkedIn",
  },
  {
    icon: GitHubIcon,
    href: "https://github.com/akshatpatel64",
    label: "GitHub",
  },
  {
    icon: MediumIcon,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2.5 px-8 py-3.5 rounded-full text-white font-medium text-sm hover:opacity-90 active:scale-95 transition-all duration-200 shadow-lg shadow-[#667eea]/25 mb-10"
          ...
          <div className="flex justify-center gap-4">
            {socials.map(({ icon: Icon, href, label }) => (
              <a
                ...
                aria-label={label}
                className="w-11 h-11 flex items-center justify-center rounded-full glass glass-hover text-slate-400 hover:text-white transition-all duration-200"
              >
                <Icon />
              </a>
            ))}
